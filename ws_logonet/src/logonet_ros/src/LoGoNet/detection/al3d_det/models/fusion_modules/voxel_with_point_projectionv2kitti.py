...
class VoxelWithPointProjectionV2KITTI(nn.Module):
    ...
    def forward(self, batch_dict, point_features, point_coords, layer_name=None, img_conv_func=None):
        ...
        # point_features = batch_dict['multi_scale_3d_features'][feature_location]
        ...
        if self.image_interp:
            # 使用双线性插值把image_feat的H1W1改变到指定的(h, w)
        ...
        for b in range(batch_size):
            ...
            # point_coords是非空体素的质心 第一维是体素数量 第二维是bxyz
            ...
            voxel_features_sparse[filter_idx] = self.fuse_blocks(pts_feats, ref_points, 
