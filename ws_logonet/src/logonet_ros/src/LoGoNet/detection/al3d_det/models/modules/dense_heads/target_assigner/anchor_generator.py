...
class AnchorGenerator(object):
    ...
    def generate_anchors(self, grid_sizes):
        ...
        for grid_size, anchor_size, anchor_rotation, anchor_height, align_center in zip(
            ...
            # anchors [x,y,z,anchor_size.shape[0],3] 这里的3是网格点的xyz坐标
            # anchor_size [x,y,z,anchor_size.shape[0],3] 这里的3是锚框的lwh尺寸
            ...
            anchors = anchors.permute(2, 1, 0, 3, 4, 5).contiguous()  # 执行完后 anchors [z,y,x,num_anchor_size,num_rot,7] 这里的7是xyz dx dy dz r
            #anchors = anchors.view(-1, anchors.shape[-1])
            
            # 这里将锚框的z值向上移动了dz/2
            anchors[..., 2] += anchors[..., 5] / 2  # shift to box centers
            
            # 这里的all_anchors包含每个类别在整个网格上的锚框
