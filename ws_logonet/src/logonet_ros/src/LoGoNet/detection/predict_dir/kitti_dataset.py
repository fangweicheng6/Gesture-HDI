...
from al3d_det.utils.kitti_utils import box_utils, calibration_kitti, common_utils, object3d_kitti
from al3d_det.utils.kitti_utils.aws_utils import list_oss_dir
    ...
    def generate_prediction_dicts(batch_dict, pred_dicts, class_names, output_path=None):
        ...
        for index, box_dict in enumerate(pred_dicts):
            ...
            if output_path is not None:
                ...
                # 将文件名改为当前日期和时间的格式
                cur_det_file = f'{output_path}/{current_time}.txt'
